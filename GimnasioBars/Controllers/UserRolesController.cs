...
namespace GimnasioBars.Controllers
{
    ...
    public class UserRolesController : ControllerBase
    {
        ...
        public UserRolesController(Gimnasio_BarsContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<UserRole>> PostUserRole(UserRole userRole)
        {
          if (_context.UserRoles == null)
          {
              return Problem("Entity set 'Gimnasio_BarsContext.UserRoles'  is null.");
          }
        ...
        {
            return (_context.UserRoles?.Any(e => e.IdUserRole == id)).GetValueOrDefault();
        }
    }
}
